                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div className="flex items-center">
                                    <FaArrowRight />
                                    <span className="ms-1 text-sm font-medium md:ms-2 dark:text-lilas">Lista de ciclistas</span>
                                </div>
                            </li>
                        </ol>
                                ...
                                <div className="relative">
                                        ...
                                        <div className="w-1/2">
                                            <form className="flex items-center">                                               
                                                <div className="relative w-full">
                                                    ...
                                                    <input type="text" id="pesquisarUser" className="bg-[whitesmoke] rounded-md text-sm block w-full pl-10 py-3 px-2 focus:dark:ring-lilas dark:border-lilas outline-none border-2 border-lilas" placeholder="Pesquisar utilizador" required="" />
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div className="overflow-x-auto rounded">
                                        <table className="w-full text-sm rounded ">
                                            ...
                                            <tbody>
                                                <LinhaTabelaUsers id="1" nome="André Lubambi"   genero="Masculino"  numbi="006754106LA044"  dataNasci="03-03-2000"  telefone="937654978"  dataCriacao="20-04-2024" dataActualizacao="04-07-2024"/>
                                                <LinhaTabelaUsers id="2" nome="Petia Paulo"     genero="Femenino"   numbi="004387254LA098"  dataNasci="09-08-1999"  telefone="946753908"  dataCriacao="22-04-2024" dataActualizacao="15-07-2024"/>
                                            </tbody>
                                        </table>
                                    </div>
