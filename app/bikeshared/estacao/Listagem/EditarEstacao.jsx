        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg p-5 w-3/4 max-w-lg relative">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <label htmlFor="dataCriacao" className="block text-sm font-medium text-gray-700">Data de Criação</label>
                        <input
                            id="dataCriacao"
                            name="dataCriacao"
                            type="date"
                    ...
                    <div className="mb-4">
                        <label htmlFor="dataActualizacao" className="block text-sm font-medium text-gray-700">Data de Atualização</label>
                        <input
                            id="dataActualizacao"
                            name="dataActualizacao"
                            type="date"
                            value={formData.dataActualizacao}
                            onChange={handleChange}
                            className="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                            required
                        />
