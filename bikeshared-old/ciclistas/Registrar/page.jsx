                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div className="flex items-center">
                                    <FaArrowRight />
                                    <span className="ms-1 text-sm font-medium md:ms-2 text-lilas">Cadastro de utilizadores</span>
                                </div>
                            </li>
                        </ol>
                            ...
                            <section className='w-3/5 mt-[-55px] mx-auto flex justify-center'>
                                <div className="w-full mx-auto max-w-screen-xl py-16">
                                    <section className="py-2">
                                        {section && (
                                            <form onSubmit="" className="container flex flex-col mx-auto space-y-12">
                                                <fieldset className="gap-6 p-6 bg-gray-50 rounded-md shadow-sm dark:bg-gray-50 pt-8">
                                                    <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                                                        ...
                                                        <div className="col-span-full sm:col-span-3">
                                                            <label htmlFor="senha" className="text-lilas">Senha</label>
                                                            <input id="senha" name="senha" type="text" placeholder="Digite a senha" className="w-full placeholder:text-lilas my-2 shadow rounded focus:outline-none dark:text-lilas text-sm focus:dark:ring-lilas dark:border-lilas" required />
                                                        </div>
                                                    </div>
